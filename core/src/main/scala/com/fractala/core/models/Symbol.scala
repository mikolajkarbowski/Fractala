...
/** Represents the symbols used in the L-System (Lindenmayer system). These symbols include commands for drawing,
  * movement, turtle transformations, and stack operations.
  */
enum Symbol:
  /** Draw a line forward. */
  case DrawForward
