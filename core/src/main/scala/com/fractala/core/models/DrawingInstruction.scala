...
enum DrawingInstruction {
   ...
   *
   * @param xFrom The starting X coordinate.
   * @param yFrom The starting Y coordinate.
   * @param xTo The ending X coordinate.
   * @param yTo The ending Y coordinate.
   ...
   * @param radius The radius (width) of the dot.
   */
  case DrawDot(
    x: Double,
    y: Double,
