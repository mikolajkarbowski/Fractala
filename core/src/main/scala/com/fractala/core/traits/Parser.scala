...
trait Parser {
  ...
  /** Parses a sequence of characters into a list of L-System symbols. This is particularly useful for parsing
    * standalone axioms or individual symbol strings outside a full DSL document.
    *
    * @param input
  ...
  /** Parses a single production rule definition. Supports deterministic rules as well as stochastic rules with weights.
    *
    * @param input
    *   The string definition of the rule (e.g., "F (0.50) -> F [ + F ]").
    * @return
